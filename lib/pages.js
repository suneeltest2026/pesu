...
module.exports = {
  ...
  delivery: (s) => ({
    ...
    body: `
      ...
      <p>We deliver within the United Arab Emirates only.</p>
      <p>Delivery times are estimates. Weather, public holidays and remote addresses can add
      to them.</p>
  ...
  returns: (s) => ({
    ...
    body: `
      ...
      confirm it and tell you where to send the piece. Sending it back is arranged and paid for by
      you &mdash; unless it arrived damaged or was not what you ordered, in which case write to us
      first and we will sort it out. Items sent back without requesting a return first cannot be
      accepted.</p>
  ...
  gifting: (s) => ({
    ...
    lede: 'Packed carefully and checked before it leaves us.',
    body: `
      <p>Every order is packed carefully and checked before it goes out, so most of the range is a
      gift you can send straight to the person receiving it. Add their
  ...
  privacy: (s) => ({
    ...
    body: `
      ...
      keep a record of what you bought. It is held in our own database, hosted for us in the
      European Union.</p>
      <h3>Payments</h3>
      ...
      <p>We do not sell your data. We share it only with the courier delivering your order, the
      payment provider processing your payment, and the companies that host this site and its
      database for us.</p>
      <h3>Email</h3>
      <p>We email you about your order. We only add you to our mailing list if you ask, and you
      can write to <a href="mailto:${s.shop_email}">${s.shop_email}</a> at any time to be taken
      off it.</p>
      <h3>Your rights</h3>
